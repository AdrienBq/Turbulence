...
'''
## Description
This is a test where we try to predict fluxes by using a PCA to reduce the dimension of the input before passing it through a DNN.
'''
...
def main():
    ...
    for i in range(len(models)):
        torch.save(models[i].state_dict(), f"models/pca_net.pt")
