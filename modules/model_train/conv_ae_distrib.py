...
'''
## Description
This is the final model architecture for predicting sub-grid heat fluxes. See section 2 of the paper for details.
'''
...
def main():
    ...
    torch.save(models[0].state_dict(), f"models/conv_ae_d_net.pt")
