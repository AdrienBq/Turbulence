...
'''
## Description
This is the first model we came up with. It serves as a baseline. See section 2 of the paper for details.
'''
...
def main():
    ...
    torch.save(models[0].state_dict(), f"models/simple_net.pt")
