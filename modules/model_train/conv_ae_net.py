...
'''
## Description
This is the final model architecture without the Gaussian distribution for predicting sub-grid heat fluxes. See section 2 of the paper for details.
'''
...
def main():
    ...
    torch.save(models[0].state_dict(), f"models/conv_ae_net.pt")
