...
'''
## Description
This is a test where we train an AE for each variable and a feed forward network for the prediction of sub-grid heat fluxes simultaneously.
'''
...
def main():
    ...
    torch.save(models[0].state_dict(), f"models/dnn_ae_net.pt")
