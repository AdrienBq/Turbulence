...
'''
## Description
This is the model where we train one model on different coarse-graining levels. See section 3 of the paper for details.
One can use it afterwards to train only on some coarse graining factors and test on others,...
'''
...
def main():
    ...
    torch.save(meta_model.state_dict(), f"models/1664_net.pt")
